...
COMMANDS = [
    ...
    "PYTHONPATH=. python3 scripts/run_streaming_demo_v0.py",
    "PYTHONPATH=. python3 scripts/validate_streaming_extension_v0.py",
    "PYTHONPATH=. python3 scripts/export_streaming_extension_summary_v0.py",
